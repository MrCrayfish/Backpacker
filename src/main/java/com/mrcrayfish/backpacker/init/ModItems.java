...
public class ModItems
{
    ...
    public static final RegistryObject<Item> RUCKSACK = REGISTER.register("rucksack", () -> new UpgradedBackpackItem(Config.COMMON.rucksackInventorySize.get(), Backpacker.RUCKSACK_TEXTURE, new Item.Properties().maxStackSize(1).group(ItemGroup.MISC)));
